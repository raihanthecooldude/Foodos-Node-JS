...
module.exports={
	...
	getAllArea: function(searchparams, callback){
		...
		var sql = "SELECT * FROM restaurant, food, restaurant_by_area, area where restaurant_by_area.AID = area.AID and restaurant_by_area.RID = restaurant.RID and restaurant.RID = food.RID and food.category ='" +searchparams.food+ "' and food.price <= "+searchparams.price+" and area.area_name ='"+searchparams.area+"'";
